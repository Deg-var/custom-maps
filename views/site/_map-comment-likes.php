...
<div class="commentLikeBtn" data-comment-id="<?= $comment->id ?>">
    <svg fill="#000000" height="20px" width="20px" version="1.1" id="Capa_1"
         ...
         viewBox="-3 -3 65 65" xml:space="preserve">
                <g>
                    <path
                        <?= ArrayHelper::keyExists(Yii::$app->user->id, ArrayHelper::index(ArrayHelper::toArray($comment->likes), 'user_id'))
                            ? 'fill="red" stroke-width="5" stroke="purple"'
                            : ''; ?>
